    ...
    <Container>
      <Panel>
        <div className="title">
          ...
          <Tooltip
            title={`${showGroups ? "Hide" : "Show"} groups`}
            placement="right"
            arrow
            classes={{ tooltip: classes.tooltip }}
          >
        ...
        <div className="title">
          <Tooltip
            title="Search followed hashtags"
            placement="right"
            arrow
            classes={{ tooltip: classes.tooltip }}
          >
            <span
              onClick={() =>
                openPage("/feed/following/?filterType=channel&focused=true")
              }
            >
              Followed Hashtags
            </span>
          ...
          <Tooltip
            title={`${showTags ? "Hide" : "Show"} followed hashtags`}
            placement="right"
            arrow
            classes={{ tooltip: classes.tooltip }}
          >
        ...
        <div className={`tags-list${showTags ? "" : " hidden"}`}>
          {tags.map((item, index) => (
            ...
            >
              <span
                className="tag"
                onClick={() => openPage(`feed/hashtag/${item}/`)}
              >
                <HashtagIcon />
                {item}
              </span>
        ...
        <div className="discover">
          <Tooltip
            ...
            classes={{ tooltip: classes.tooltip }}
          >
            <span onClick={() => openPage("mynetwork/discover-hub/")}>
              Discover More
            </span>
          </Tooltip>
        </div>
